...
> 这是解释型总览，不是 family/run 的 canonical 索引。
> 最新状态、准入规则和 terminal run 统一看 [docs/experiments/registry.md](../experiments/registry.md)、[docs/experiments/runs.csv](../experiments/runs.csv) 与对应 closeout 报告。
