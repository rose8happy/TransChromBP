...
> 注：本文件主要用于理解旧版 ChromBPNet 项目结构与基础设计。当前默认主线模型已经演进为 `TransChromBP`；如果你要理解现在实际训练、评估、写论文使用的模型，请先看 [TransChromBP当前模型学习总览.md](TransChromBP当前模型学习总览.md) 和 [TransChromBP当前模型详解.md](TransChromBP当前模型详解.md)。
