...
Phase 0 结果是黄灯（AUC ~0.67，当前候选层位为 `layer_6`），所以即便优先级提高，进入 Phase 1 仍需要满足 checklist（`docs/plan/genos_phase1_rebase_checklist.md`）：
- 代码基于当前主线（`vendor/transchrombp/transchrombp`）
- matched baseline 对照（G0/G1/G2 三组）
- Genos frozen + no_grad + eval()

同时应遵守最小接入方案（`docs/plan/genos_phase1_minimal_integration_plan.md`）：
...
- 实验详细设计：`docs/plan/v2_code_improvement_ablations.md`
- 读出头实验设计：`docs/plan/v2fix_readout_head_experiment_design.md`
- Genos Phase 1 checklist：`docs/plan/genos_phase1_rebase_checklist.md`
- Genos 最小接入方案：`docs/plan/genos_phase1_minimal_integration_plan.md`
- 6002 独立实验线清单：`docs/plan/6002_independent_experiment_queue_20260321.md`
- 项目追踪清单：`TRACKING.md`
