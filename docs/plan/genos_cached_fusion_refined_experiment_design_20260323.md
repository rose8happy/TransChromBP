...
- 启动入口是 `tmp_remote_edit/transchrombp/scripts/run_genos_pilot.sh`
- 训练配置是 `tmp_remote_edit/transchrombp/configs/train/train_v2fix_genos_profile_select.yaml`
...
真实数据集实现是 `tmp_remote_edit/transchrombp/data/real_data.py`，其中：
