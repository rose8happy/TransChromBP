...
4. `reports/handoff/repository_status_handoff_20260409.md` 等快照 / handoff / 历史计划文档

三份常用文档的职责固定如下：

- `docs/plan/dual_machine_experiment_charter_20260409.md`：规则源
- `TRACKING.md`：live 状态与下一步
- `docs/experiments/registry.md` / `docs/experiments/runs.csv`：family/workstream 与 run 的 canonical 索引
- `reports/handoff/repository_status_handoff_20260409.md`：仓库 / worktree / 双机现场快照
