...
- This round completed the helper-bridge part of the plan locally: [test_chrombpnet_official_externalization.sh](/home/zhengwei/project/python/TransChromBP/tests/test_chrombpnet_official_externalization.sh), [run_remote_chrombpnet_dataset_prep.sh](/home/zhengwei/project/python/TransChromBP/scripts/run_remote_chrombpnet_dataset_prep.sh), [start_6000_chrombpnet_dataset_prep.sh](/home/zhengwei/project/python/TransChromBP/scripts/start_6000_chrombpnet_dataset_prep.sh), [start_6002_chrombpnet_dataset_prep.sh](/home/zhengwei/project/python/TransChromBP/scripts/start_6002_chrombpnet_dataset_prep.sh), and [step3_get_background_regions.sh](/home/zhengwei/project/python/TransChromBP/workflows/tutorial/step3_get_background_regions.sh) now pass the local guard and `bash -n`.
...
- `reports/governance/chrombpnet_official_patch_ledger_20260406.md`
...
**Files:**
- Create: `reports/governance/chrombpnet_official_patch_ledger_20260406.md`
- Modify: `scripts/paper_aligned_repro/README.md`
- Test: `reports/governance/chrombpnet_official_patch_ledger_20260406.md`
...
Run: `rg -n 'CHROMBPNET_OFFICIAL_ROOT=/data1/zhoujiazhen/bylw_atac/chromBPNet|chrombpnet_official_patch_ledger_20260406.md' scripts/paper_aligned_repro/README.md reports/governance/chrombpnet_official_patch_ledger_20260406.md`

Expected: FAIL because `reports/governance/chrombpnet_official_patch_ledger_20260406.md` does not exist yet and the README still points operators at the local repo.
...
- 官方 patch 台账见 `reports/governance/chrombpnet_official_patch_ledger_20260406.md`
````
...
Run: `PLACEHOLDER_PATTERNS='TO''DO|TB''D|之后再''说|稍''后|占''位'; rg -n "$PLACEHOLDER_PATTERNS" scripts/paper_aligned_repro/README.md reports/governance/chrombpnet_official_patch_ledger_20260406.md`
...
```markdown
| 官方 ChromBPNet 外置化实施 | 待验证 | design 与 implementation plan 已执行完成；本仓已切断 active local-official 依赖、补齐 patch ledger、删除本地 `chrombpnet/` 与官方 packaging 入口。 | 在 6000 用一次真实 official compare / dataset-prep smoke 验证桥接链路；若通过，再把该条移入 `TRACKING_archive.md`。 | `docs/plan/archive/governance/chrombpnet_official_externalization_design_20260406.md`、`docs/plan/archive/governance/chrombpnet_official_externalization_implementation_plan_20260406.md`、`reports/governance/chrombpnet_official_patch_ledger_20260406.md` |
```
