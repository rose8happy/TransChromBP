...
> 更新（`2026-04-09 22:11 CST`）：本文档是论文 / 项目的长周期路线图，不负责当前 `6000/6002` 双机实验调度；只要 `docs/plan/dual_machine_experiment_charter_20260409.md` 的白名单队列未收口，就不能引用本文把默认动作切回“先写论文”。
...
| 1.3 | **组装 L3 对比表** | 0.3 + 1.2 | 已完成；shared-region 对比报告见 `reports/analysis/tutorial_L3_shared_region_closure_20260330.md` |
...
| **P1** | 6002 单卡 runs 说明 | 保留为独立真实数据验证，不挤进 tutorial 主 benchmark | `reports/analysis/v2fix_and_6000_realdata_followup_20260325.md` |
...
| 4.3 仓库清理 | 按 `docs/plan/archive/scheduling/git_cleanup_and_archive_plan_20260321.md` 执行：移除 .h5/.pt、清理 tmp_remote_edit/、更新 README |
...
| 文件 | 用途 |
|------|------|
| `reports/paper/transchrombp_paper_draft_v1.tex` | 英文论文主稿（显式 TODO 已清零；当前重点是 foundation 口径与投稿前打磨） |
| `reports/paper/transchrombp_paper_cn_v1.tex` | 中文论文主稿（833 行） |
| `reports/paper/paper_claim_evidence_matrix_20260326.md` | 论证强度权威指南 |
| `reports/paper/paper_rewrite_strategy_20260326.md` | 论文叙事策略 |
| `reports/analysis/tutorial_L2_locked_followup_20260329.md` | L2 follow-up 模板（L3 可复用） |
...
| `docs/plan/archive/scheduling/git_cleanup_and_archive_plan_20260321.md` | 仓库清理方案 |
