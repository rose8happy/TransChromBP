...
> `docs/plan/a6000_foundation_reentry_candidates_20260405.md` 和 `TRACKING.md` 为准。
...
- held-out 结果出来后，统一按 `docs/plan/post_chatgpt_pro_priority_execution_20260405.md` 的决策树执行：
