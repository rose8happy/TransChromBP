...
> 更新（`2026-04-09 22:11 CST`）：本文档只保留 `2026-04-05/06` 那一轮 foundation 停表背景；当前双机实验优先级，以及“是否继续实验而不是先写论文”的裁决，统一改以 `docs/plan/2026-04-09_dual_machine_experiment_charter.md` 为准。
