...
**Files:**
- Create: `docs/plan/2026-04-09_dual_machine_experiment_charter.md`
- Modify: `TRACKING.md`
...
- 规则源：本文件
- live 状态：`TRACKING.md`
- 仓库/分支快照：`reports/repository_status_handoff_20260409.md`
```
...
Write:
```markdown
> 实验规则源统一看 `docs/plan/2026-04-09_dual_machine_experiment_charter.md`；
> 仓库 / worktree / 双机运行快照看 `reports/repository_status_handoff_20260409.md`。
```
...
**Files:**
- Modify: `reports/repository_status_handoff_20260409.md`
- Modify: `docs/plan/post_chatgpt_pro_priority_execution_20260405.md`
- Modify: `docs/plan/project_roadmap_20260330.md`
...
> `docs/plan/2026-04-09_dual_machine_experiment_charter.md` 为准。
```
...
git diff --check -- \
  ...
  docs/plan/post_chatgpt_pro_priority_execution_20260405.md \
