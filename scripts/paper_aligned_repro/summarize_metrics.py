...
METRIC_KEYS = [
    ...
    "chrom_profile_mean_jsd_peaks",
    "chrom_profile_median_jsd_peaks",
    "chrom_profile_median_norm_jsd_peaks",
    "chrom_peak_vs_nonpeak_auroc_logcounts",
    "chrom_peak_vs_nonpeak_auprc_logcounts",
    "chrom_peak_vs_nonpeak_best_f1_logcounts",
...
def row_from_run(seed_dir: Path):
    ...
    row = {
        ...
        "chrom_profile_mean_jsd_peaks": safe_get(chrom, ["profile_metrics", "peaks", "mean_jsd"]),
        ...
        "chrom_peak_vs_nonpeak_auroc_logcounts": safe_get(chrom, ["classification_metrics", "peaks_vs_nonpeaks", "logcounts", "auroc"]),
        "chrom_peak_vs_nonpeak_auprc_logcounts": safe_get(chrom, ["classification_metrics", "peaks_vs_nonpeaks", "logcounts", "auprc"]),
        "chrom_peak_vs_nonpeak_best_f1_logcounts": safe_get(chrom, ["classification_metrics", "peaks_vs_nonpeaks", "logcounts", "best_f1"]),
