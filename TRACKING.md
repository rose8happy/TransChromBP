...
> active local canonical root 已切换为 `/home/zhengwei/project/python/TransChromBP`；旧 `/home/zhengwei/project/python/chromBPNet` 若仍存在，只作为兼容 symlink / rollback path，不再作为 canonical entrypoint。
