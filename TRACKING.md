...
|---|---|---|---|---|
| 仓库任务盘点（2026-04-09） | 进行中 | 截至 `2026-04-09 22:11 CST`，本轮 worktree cleanup 已完成：`master` 已恢复为 clean 的 canonical 档案仓，并用本轮 docs closeout 收口主档案；实验/工程支线也已各自冻结为 clean worktree + 本地提交：`dual-track-20260409 -> 4ffc6e7 (wip: snapshot dual track pivot)`、`autonomy/20260406-structure -> 764b8c0`、`autonomy/20260406-chrombpnet-externalization -> 4aadffa`。当前 live 实验面已按新 charter 收口为：`6000` 仍在跑 `ntv2_teacher_distill_short10_s42_6000_20260409_r2`，`6002` 当前空闲，但 `U-Net-lite r1/r2/r3` 已实际完成，正等待正式 verdict。 | 按 charter 先做两件事：等 `6000 teacher-distill short10` 收口并正式判 gate，同时把 `6002 U-Net-lite` 收成 verdict；在白名单队列没收口前，不默认切回“先写论文”。 | `docs/plan/2026-04-09_dual_machine_experiment_charter.md`、`reports/repository_status_handoff_20260409.md`、`reports/project_plan_code_review_20260405.md`、`docs/plan/project_roadmap_20260330.md`、`docs/plan/workspace_cleanup_plan_20260405.md` |
...
| 6002 RTX 3080 单卡实验侧线 | 进行中 | 截至 `2026-04-09 22:11 CST`，`6002` 的 3080 当前空闲，且没有活跃 `transchrombp.training.train_ddp` 进程；但 `U-Net-lite` 并不是“尚未起跑”，而是已经实际跑过 `teacher_v2_center_pool_unet_lite_v1_short10_s42_6002_20260409_r1/r2/r3`。其中 `r3` 日志显示 best 出现在 `epoch=2`，峰区 `profile_target_jsd_full_mean=0.45525`，并已打印 `U-Net-lite decoder probe completed.`。 | 先把 `U-Net-lite r1/r2/r3` 收成正式 verdict；若判负，则继续 `dense decoder / readout family` 的 genuinely new 变体，只有在没有 ready 变体时才转 `AlphaGenome matched raw-track slice`。 | `docs/plan/2026-04-09_dual_machine_experiment_charter.md`、`reports/repository_status_handoff_20260409.md`、`reports/project_plan_code_review_20260405.md` |
