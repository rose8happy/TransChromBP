...
|---|---|---|---|---|
| 仓库任务盘点（2026-04-09） | 进行中 | 截至 `2026-04-09 22:41 CST`，本轮 worktree cleanup 已完成：`master` 已恢复为 clean 的 canonical 档案仓，并用本轮 docs closeout 收口主档案；实验/工程支线也已各自冻结为 clean worktree + 本地提交：`dual-track-20260409 -> 4ffc6e7 (wip: snapshot dual track pivot)`、`autonomy/20260406-structure -> 764b8c0`、`autonomy/20260406-chrombpnet-externalization -> 4aadffa`。当前 live 实验面按新 charter 收口为：`6000` 仍在跑 `ntv2_teacher_distill_short10_s42_6000_20260409_r2`；`6002` 则已按 rigor review 补起确认性 cheap rerun `teacher_v2_center_pool_unet_lite_v1_short10_s42_6002_20260409_r4`，目的是确认 `r3` 是否只是单次偶然波动。 | 按 charter 先做两件事：等 `6000 teacher-distill short10` 收口并正式判 gate，同时等 `6002 U-Net-lite r4` 收口；随后把 `v1` 正式收成“可停表”还是“仅 single-run no-go”。在白名单队列没收口前，不默认切回“先写论文”。 | `docs/plan/2026-04-09_dual_machine_experiment_charter.md`、`reports/unet_lite_v1_rigor_review_20260409.md`、`reports/repository_status_handoff_20260409.md`、`reports/project_plan_code_review_20260405.md`、`docs/plan/project_roadmap_20260330.md` |
