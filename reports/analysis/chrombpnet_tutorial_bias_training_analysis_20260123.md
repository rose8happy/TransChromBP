...
- This report now lives under `reports/` because it is a reusable analysis summary rather than a root-level note.
- Small companion assets, if they need to be kept with the repo, should live under `reports/assets/chrombpnet_bias_training_20260123/`.
