...
## 6. 这份文件背后的关键源报告
如果你想核查更细节的证据链，核心源头是：
- `reports/transchrombp_full_review_20260326.md`
- `reports/paper_rewrite_strategy_20260326.md`
- `reports/profile_shortcut_revalidation_summary_20260326.md`
- `reports/paper_claim_evidence_matrix_20260326.md`
- `reports/v2fix_and_6000_realdata_followup_20260325.md`
