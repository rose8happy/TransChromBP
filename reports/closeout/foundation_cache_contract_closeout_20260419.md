...
- `reports/governance/project_plan_code_review_20260405.md` 解释了这条问题线最初是如何暴露出来的。
- `reports/governance/foundation_cache_contract_snapshot_20260406.md` 是上一轮的保留说明，回答“为什么还不能直接删掉这条 branch/worktree”。
...
1. 先读：
   - `reports/governance/project_plan_code_review_20260405.md`
   - `reports/governance/foundation_cache_contract_snapshot_20260406.md`
   - 本文
2. 再从以下入口恢复代码现场：
   - branch `autonomy/20260406-structure`
