...
- 状态与决策文档：`TRACKING.md`、`docs/plan/*.md`、`reports/analysis/foundation_model_restart_v3_implementation_20260405.md`
...
- `2026-04-05` 已落地：`docs/plan/archive/foundation/post_chatgpt_pro_priority_execution_20260405.md` 与 `reports/analysis/foundation_model_restart_v3_implementation_20260405.md` 已补充“默认停表 vs 显式授权受控重入”的优先级说明。
...
- 证据：
  ...
  - 当前计划文档已记录过一次真实故障：缺 `manifest_test.json` 导致 held-out `test-full` 失败：`docs/plan/archive/foundation/foundation_model_restart_v3_20260405.md:126`
- 影响：
...
- 证据：
  - `post_chatgpt_pro_priority_execution` 定义：`fail-or-unsafe` 后应停表，不继续 foundation：`docs/plan/archive/foundation/post_chatgpt_pro_priority_execution_20260405.md:77-90`
  - `restart_v3 implementation` 也写明“不跑 matched no-foundation control”：`reports/analysis/foundation_model_restart_v3_implementation_20260405.md:173`
