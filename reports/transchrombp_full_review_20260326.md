...
| 报告 | 路径 |
|------|------|
| 本报告 | `reports/transchrombp_full_review_20260326.md` |
| 论文改写策略 | `reports/paper_rewrite_strategy_20260326.md` |
| Claim-Evidence 矩阵 | `reports/paper_claim_evidence_matrix_20260326.md` |
| Profile Shortcut 复核 | `reports/profile_shortcut_revalidation_summary_20260326.md` |
| 指标源数据总表 | `reports/assets/paper_metric_source_table_20260326.csv` |
| Genos 负结果分析 | `reports/genos_no_positive_gain_analysis_20260323.md` |
| Genos 完整技术报告 | `reports/genos_integration_full_report_for_review_20260324.md` |
| 读出头实验状态 | `reports/v2fix_readout_head_status_20260323.md` |
| 独立数据跟进 | `reports/v2fix_and_6000_realdata_followup_20260325.md` |
