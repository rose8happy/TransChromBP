...
4. 逐个判定根目录 6 份参考材料后，做了明确分流：
   ...
   - `bias_training_curve.svg`、`bias_training_curve_detailed.svg`、`bias_training_log.csv` 因为被 `reports/chrombpnet_tutorial_bias_training_analysis_20260123.md` 显式引用且体积很小，归类为正式小型报告资产，迁入 `reports/assets/chrombpnet_bias_training_20260123/`。
