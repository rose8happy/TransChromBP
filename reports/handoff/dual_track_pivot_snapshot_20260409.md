...
- 尤其 `U-Net-lite` 相关实现，只能视作当时本地 archival snapshot；它和 6002 runtime 上实际运行过的实现并不完全等价。这个差异已在 `reports/analysis/unet_vs_alphagenome_reassessment_20260411.md` 中记录。
...
1. 先读本报告与相关 closeout：
   - `reports/closeout/unet_lite_v1_rigor_review_20260409.md`
   - `reports/closeout/ntv2_teacher_distill_short10_gate_closeout_20260409.md`
